package com.fjh.flink.olap.networkflow;
 ...
 *
 * @author fjh
 * @since 2021/12/3 16:11
 */

import com.fjh.flink.olap.networkflow.bean.PageViewCount;
...
import com.fjh.flink.olap.networkflow.bean.ApacheLogEvent;
...
//        DataStream<String> inputStream = env.socketTextStream("localhost", 7777);
        ...
        DataStream<String> inputStream = env.addSource(new FlinkKafkaConsumer<String>("hotPage", new SimpleStringSchema(), properties));
